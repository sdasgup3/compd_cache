...
define %struct.Memory* @routine_callq_.unmark_long_term_field_for_reference_by_frame_idx(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
