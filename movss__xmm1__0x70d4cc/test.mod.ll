...
define %struct.Memory* @routine_movss__xmm1__0x70d4cc(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
  ...
  %10 = add i64 %9, 9
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L9MOVSS_MEMI4MVnWI7vec32_tE2VnI8vec128_tEEEP6MemoryS8_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 7394508, i8* %8)
